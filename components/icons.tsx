...
export function WhatsAppIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={iconClass(className)} aria-hidden="true">
      <path d="M20.52 3.48A11.8 11.8 0 0 0 12.12 0C5.62 0 .34 5.28.34 11.78c0 2.08.54 4.11 1.58 5.9L0 24l6.49-1.7a11.76 11.76 0 0 0 5.63 1.44h.01c6.5 0 11.78-5.28 11.78-11.78 0-3.15-1.23-6.1-3.39-8.48Zm-8.4 18.28h-.01a9.78 9.78 0 0 1-4.98-1.36l-.36-.21-3.85 1 1.03-3.75-.24-.38a9.77 9.77 0 0 1-1.5-5.23c0-5.41 4.4-9.81 9.83-9.81 2.62 0 5.08 1.02 6.93 2.89a9.72 9.72 0 0 1 2.86 6.93c0 5.42-4.4 9.82-9.81 9.82Zm5.39-7.33c-.3-.15-1.77-.87-2.05-.97-.27-.1-.47-.15-.66.15-.2.3-.76.96-.93 1.15-.17.2-.34.22-.64.08-.3-.15-1.24-.45-2.37-1.45-.88-.78-1.47-1.74-1.64-2.04-.17-.3-.02-.46.13-.61.14-.14.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.38-.02-.53-.08-.15-.67-1.62-.93-2.22-.24-.58-.49-.5-.66-.5h-.57c-.2 0-.53.08-.8.38-.27.3-1.04 1.01-1.04 2.46 0 1.45 1.07 2.85 1.22 3.05.15.2 2.08 3.17 5.03 4.44.7.3 1.26.48 1.69.61.71.22 1.35.19 1.86.12.57-.08 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.13-.27-.2-.57-.35Z" />
    </svg>
  );
}
